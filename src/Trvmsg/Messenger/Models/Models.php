...
class Models
{
     ...
     * @param string $model
     */
    public static function setEventMessageModel($model)
    {
        static::$models[EventMessage::class] = $model;
    }
     ...
     * @return void
     */
    public static function setEventParticipantModel($model)
    {
        static::$models[EventParticipant::class] = $model;
    }
     ...
     *
     * @param  array $attributes
     * @return \Trvmsg\Messenger\Models\Participant
     */
    ...
    /**
     * Get an instance of the event messages model.
     *
     * @param  array $attributes
     * @return \Trvmsg\Messenger\Models\Message
     */
    public static function evMessage(array $attributes = [])
    {
        return static::make(EventMessage::class, $attributes);
    }

    /**
     * Get an instance of the event participants model.
     *
     * @param  array $attributes
     * @return \Trvmsg\Messenger\Models\Participant
     */
    public static function evParticipant(array $attributes = [])
    {
        return static::make(EventParticipant::class, $attributes);
    }
     ...
     *
     * @param  array $attributes
     * @return \Trvmsg\Messenger\Models\Thread
     */
