...
class TestCase extends Orchestra
{
    ...
    {
        $app['config']->set('messenger.message_model', 'Trvmsg\Messenger\Models\Message');
        $app['config']->set('messenger.participant_model', 'Trvmsg\Messenger\Models\Participant');
        $app['config']->set('messenger.thread_model', 'Trvmsg\Messenger\Models\Thread');
    }
